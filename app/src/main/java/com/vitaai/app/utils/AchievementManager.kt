...
object AchievementManager {
    ...
    val ALL: List<Achievement> = listOf(
        ...
        Achievement("first_exercise", "ach_first_exercise_t", "ach_first_exercise_d", 20),
        ...
        Achievement("food_10", "ach_food10_t", "ach_food10_d", 50),
        Achievement("food_50", "ach_food50_t", "ach_food50_d", 150),
